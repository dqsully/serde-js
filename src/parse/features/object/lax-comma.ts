    ...
    public* parse(
        ...
        if (char === '}') {
            ...
            while (true) {
                ...
                // Parse the colon
                if (char !== ':') {
                    return () => `expected '${char}' to be ':' for a lax-comma object`;
                }
                ...
                if (char === '}') {
                    ...
                    return () => `expected '${char}' to be ',' or '}' for a lax-comma object`;
                }
        ...
        visitor.impl.setMetadata(visitor.context, 'object.type', 'lax-comma');
